/*
 * The general set-up of this file originated from:
 * OGL02Animation.cpp: 3D Shapes with animation
 * significant changes have been made within openGL functions
  * to alter the functionality of the code
 */
#include <GL/glut.h>  // GLUT, include glu.h and gl.h

/* Global variables */
char title[] = "3D Cube with animation";
GLfloat cubeLocale = 1.0f;     // Length of the cude
...
void display() {
  ...
  //  glRotatef(angleCube, 1.0f, 1.0f, 1.0f);  // Rotate about (1,1,1)-axis [NEW]
   ...
   glBegin(GL_QUADS); // Begin drawing the square
      ...
      glVertex3f( cubeLocale,  0.25f, 0.25f);
